...
An orientation on $\sigma$ is the choice of anyone of these 2 classes. An oriented is a simplex $\sigma$ with a choice of an orientation on it. For $n=0$ there is no choice and $\sigma$  is consider oriented by default.