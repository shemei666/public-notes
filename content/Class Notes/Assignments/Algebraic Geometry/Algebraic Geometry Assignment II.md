...
\end{aligned}
$$
Since $Z=0$ is the tangent to the inflexion point, we see that $a_{1}X^3 + a_{2}X^2Y +  a_{4}XY^2 +   a_{7}Y^3$ needs to have a triple root at $(0,1)$ hence we have $a_1 = a_2 = a_4 = a_7 = 0$.