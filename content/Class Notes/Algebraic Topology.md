...
\prod M*{i} \xrightarrow{p*{i}} M\_{i}
...
\text{Maps}\left( N,\prod M*{i} \right) \leftrightarrow \{ \text{Maps}(N,M*{i}) \}\_{i \in I}
...
\text{Maps}\left(\bigoplus M*{i},N\right) \leftrightarrow \{ \text{Maps} (M*{i},N)\}\_{i \in I}
...
\begin{gather*}
(\bigoplus M*{i}) \oplus (\bigoplus M*{j}) \cong \bigoplus M*{k} \\
\bigoplus M*{(i,j) \in I\times J} \cong \bigoplus (\bigoplus M\_{i,j})
\end{gather*}
...
\text{Maps}(G,H) \to \{ \text{Maps}(G*{\alpha},H) \}*{\alpha \in A}
...
w \* v = \text{reduced word obtained from } (g*{1},\dots,g*{m},h*{1},\dots,h*{n})

$$
To check associativity: $w = (g_{1},\dots,g_{m},v=(h_{1},\dots,h_{n})$ and $u=(k_{1},\dots,k_{p})$. Then
$$

(w*v)*u = \text{reduced word from }(g*{1},\dots,g*{m},h*{1},\dots,h*{n},k*{1},\dots,k*{p}) = w*(v*u)
...
\begin{align*}
f(w * v) &= f(\text{reduced word from }(g*{1},\dots,g*{m},h*{1},\dots,h*{n})) \\
&= f*{\alpha*{1}}(g*{1}) \dots f*{\alpha*{m}}(g*{m})f*{\beta*{1}}(h*{1})\dots f*{\beta*{n}}(h*{n})) = f(w)f(v)
\end{align\*}
